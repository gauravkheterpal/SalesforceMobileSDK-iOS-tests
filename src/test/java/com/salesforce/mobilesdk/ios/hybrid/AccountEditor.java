...
public class AccountEditor implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
	...
	public void setUp() throws Exception {
		...
		try{
			if (runOnSauce) {
				...
				String localApp = "AccountEditor.app.zip";
	...
	public void login() throws InterruptedException {
		try {
			...
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[1]/UIAWebView[1]/UIATextField[3]")).sendKeys("Industory");
			...
			Thread.sleep(10000);
			//wd.findElement(By.name("Owned")).click();
		} 
