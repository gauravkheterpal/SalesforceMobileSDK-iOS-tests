...
public class FileExplorer implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
	...
	public void setUp() throws Exception {
		...
		try{
			if (runOnSauce) {
				...
				String localApp = "FileExplorer.app.zip";
			...
			//run on local machine
				...
				File appDir,app;
				appDir = new File( "/Users/ga/Desktop/AppFiles");
				app = new File(appDir,"FileExplorer.app");
				if(!runOnSimulator){
	...
	public void login() throws InterruptedException {
		try {
			...
			driver.findElement(By.name("Owned")).click();
