...
package com.salesforce.mobilesdk.ios.Native;
...
public class RestAPIExplorer implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
	...
	public void setUp() throws Exception {
		...
		try{
			...
			//run on local machine
				...
				app = new File(appDir,"RestAPIExplorer.app");
				if(!runOnSimulator){
	...
	public void login() throws InterruptedException {
		try {
			...
			//Thread.sleep(2000);
			driver.findElement(By.name("objectType")).click();
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIATextField[1]")).sendKeys("Account");
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIATextField[5]")).sendKeys("Select Name From Account");
			driver.findElement(By.name("Share")).click();
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[11]")).click();
			driver.findElement(By.name("Share")).click();
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[1]")).click();
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIATextField[8]")).sendKeys("/v31.0/sobjects/contact");
			driver.findElement(By.name("GO")).click();
			driver.findElement(By.name("Share")).click();
			driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[13]")).click();
